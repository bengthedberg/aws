...
2. **Create the account**
   ...
   Note that if you are using multiple AWS accounts—a very common strategy—make use of [AWS Organizations](https://docs.aws.amazon.com/organizations/latest/userguide/orgs_manage_org_create.html) See this [video](https://www.youtube.com/watch?v=zVJnenaD3U8) for an introduction to Comntrol Tower. Here is some more [information](https://codeburst.io/aws-control-tower-by-example-part-1-d1b94df4c58c)
...
7. **Activate IAM user access to billing information and billing alerts**
...
12. **Decide which regions you’ll use first**
...
15. **Create the remaining groups and users**
...
16. **Implement additional security mechanisms**
...
17. **Decide how you’ll be creating resources**
